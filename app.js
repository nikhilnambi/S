...
app.post('/api/sellerlogin',function(req,res){
 ...
 var productdata={
  ...
  quantity:req.body.productdata.quantity,
   ...
   productdata.save()
    ...
    app.get('/api/get-seller-products/:sellerid',function(req,res){
    ...
    app.get("/api/get-seller-product/:_id",function(req,res){
    ...
    app.get("/api/deleteProduct/:_id",function(req,res){
    ...
    app.get("/api/get-user-product",function(req,res){
    ...
    app.get("/api/get-cart-product/:_id",function(req,res){
    ...
    app.get("/api/cartproducts/:userid",function(req,res){
    ...
    app.get("/api/deletecartproduct/:_id",function(req,res){
      const _id = req.params._id; 
      console.log(_id);
